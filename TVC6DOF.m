...
tic
for k=1:runs
    Ix_mc=Ix_n+randn*Ix_v;%%corrections on moment of inertias
    Iy_mc=Iy_n+randn*Iy_v;
    Iz_mc=Iz_n+randn*Iz_v;

    m_dry_mc=m_dry_n+randn*m_dry_v; %%corrections on dry mass
    l_mc=l_n+randn*l_v;%%corrections on moment arm length
    servo_delay_mc=servo_delay_n+randn*servo_delay_v;%%corrections on servo delay time
    mis_y_mc=randn*mis_y_v;%%corrections on misalignment of 
    mis_z_mc=randn*mis_z_v;
    static_error_y_mc=randn*static_error_y_v;%% not sure
    static_error_z_mc=randn*static_error_z_v;%% not sure
